          ...
          ZipFile: {
            'Fn::Join': [
              ...
              [
                ...
                '    return;',
                '  } ',
                "  s3client.putObject({ Bucket: bucketName, Key: 'configuration.json', Body: Buffer.from(JSON.stringify({ region, cognitoPoolId, applicationLoginUrl, applicationClientId, customDomain, awsAccountId, identityPoolId })), ContentType: 'application/json' }).promise()",
                '    .then(() => {',
